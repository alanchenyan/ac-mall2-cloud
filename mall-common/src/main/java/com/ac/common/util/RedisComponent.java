...
public class RedisComponent {
     ...
     * @param key   键
     * @param value 至
     * @param time  超时时间   秒为单位
     * @return void
     * @author renqige
     **/
    public void setLock(String key, String value, Long time) {
        try {
            hset("redisLock", key, value, time);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            RedisConnectionUtils.unbindConnection(redisTemplate.getConnectionFactory());
    ...
    public String getLockValue(String key) {
        try {
            return (String) hget("redisLock", key);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        } finally {
    ...
    public void deleteLock(String key, String value) {
        try {
            String valueFromRedis = (String) hget("redisLock", key);
            if (valueFromRedis.equals(value)) {
                hdel("redisLock", key);
            }
        } catch (Exception e) {
            e.printStackTrace();
